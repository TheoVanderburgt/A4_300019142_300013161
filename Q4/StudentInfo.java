...
public class StudentInfo {
	...
	System.out.println("************************************************************");
	System.out.println("*Name: John Bousfield                                      *");
	System.out.println("*ID: 300013161		Section: ITI1121 C                 *");
	System.out.println("*Name: Theo Van der Burgt        		           *");
	System.out.println("*ID: 300019142               Section: ITI1121 C            *");
	System.out.println("************************************************************");
	System.out.println();
